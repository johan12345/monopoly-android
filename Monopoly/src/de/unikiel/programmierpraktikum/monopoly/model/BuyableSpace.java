...
/**
 *  Abstract class that contains all spaces that a player can buy when reaching it,
 *  such as streets, utilities and stations.
 */
...
public abstract class BuyableSpace extends Space {
    ...
    /**
     *   The rent another player but the owner has to pay when stepping upon a buyable space. Houses or hotels are included in the calculation.
     */
	public abstract double getRent();
    
    /**
     *   The price that has to be payed, should a player wish to acquire a buyable space.
     */
